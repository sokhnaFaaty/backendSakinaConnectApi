...
prochesRouter.openapi({
  ...
  path: '/',
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: z.array(ProcheSchema) } } } }
}, async (c) => {
...
prochesRouter.openapi({
  ...
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: ProcheSchema } } } }
}, async (c) => {
...
prochesRouter.openapi({
  ...
  path: '/',
  security: [{ Bearer: [] }],
  request: { body: { content: { 'application/json': { schema: ProcheSchema.omit({ id: true }) } } } },
  responses: { 201: { content: { 'application/json': { schema: ProcheSchema } } } }
}, async (c) => {
...
prochesRouter.openapi({
  ...
  request: { 
    ...
    body: { content: { 'application/json': { schema: ProcheSchema.partial() } } }
  },
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: ProcheSchema } } } }
}, async (c) => {
