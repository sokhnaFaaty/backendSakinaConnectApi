...
planningsRouter.openapi({
  ...
  path: '/',
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: z.array(PlanningSchema) } } } }
}, async (c) => {
...
planningsRouter.openapi({
  ...
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: PlanningSchema } } } }
}, async (c) => {
...
planningsRouter.openapi({
  ...
  path: '/',
  security: [{ Bearer: [] }],
  request: { body: { content: { 'application/json': { schema: PlanningSchema.omit({ id: true }) } } } },
  responses: { 201: { content: { 'application/json': { schema: PlanningSchema } } } }
}, async (c) => {
...
planningsRouter.openapi({
  ...
  request: { 
    ...
    body: { content: { 'application/json': { schema: PlanningSchema.partial() } } }
  },
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: PlanningSchema } } } }
}, async (c) => {
