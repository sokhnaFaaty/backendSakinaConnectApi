...
groupesRouter.openapi({
  ...
  path: '/',
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: z.array(GroupeSchema) } } } }
}, async (c) => {
...
groupesRouter.openapi({
  ...
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: GroupeSchema } } } }
}, async (c) => {
...
groupesRouter.openapi({
  ...
  path: '/',
  security: [{ Bearer: [] }],
  request: { body: { content: { 'application/json': { schema: GroupeSchema.omit({ id: true }) } } } },
  responses: { 201: { content: { 'application/json': { schema: GroupeSchema } } } }
}, async (c) => {
...
groupesRouter.openapi({
  ...
  request: { 
    ...
    body: { content: { 'application/json': { schema: GroupeSchema.partial() } } }
  },
  security: [{ Bearer: [] }],
  responses: { 200: { content: { 'application/json': { schema: GroupeSchema } } } }
}, async (c) => {
